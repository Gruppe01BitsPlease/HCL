...
public class CustomerManagerTest {
    ...
    public void generate() {
        ...
        manager.generate("Kjell-Sture", "Sturegutten@hotmail.com", 75584788);
        manager.generate("Kaffe-Lars", "coffein_lover@gmail.com", 75584061);
    ...
    public void edit() throws Exception {
        manager.generate("LillePer", "Storegutten@hotmail.com", 75584788);
        int lilleperID = sql.getLastID();
        manager.generate("StorePer", "lillegutten@hotmail.com", 75584061);
        int storeperID = sql.getLastID();
    ...
    public void delete() throws Exception {
        ...
        manager.generate("Kari", "kari@hotmail.com", 75583478);
        int kariID = sql.getLastID();
        manager.generate("Ola", "Ola@hotmail.com", 0075500);
        int olaID = sql.getLastID();
